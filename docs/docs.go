...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/aa/gastank/sign": {
            "post": {
                "description": "Calculates maxTokenCost for the given UserOperation, adds paymaster signature, and returns reassembled paymasterData.\nEncoding format (129 bytes): token(20) || maxTokenCost(32) || validAfter(6) || validUntil(6) || signature(65). maxTokenCost is 0-based, big-endian uint256.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/tokenpay/config": {
            "get": {
                ...
                "operationId": "tokenPayConfig",
                "responses": {
                    "200": {
                        "description": "Token-pay configuration",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/api.BusinessError"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/api.TokenPayConfig"
                                        }
                                    }
                                }
                            ]
        ...
        "/tokenpay/submit": {
            "post": {
                ...
                "operationId": "tokenPaySubmit",
                "parameters": [
                    {
                        "description": "Raw transfer-token tx and raw business tx",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.TokenPayRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "api.TokenPayConfig": {
            ...
            "properties": {
                ...
                "suggestedGasPriceBumpRatio": {
                    "description": "SuggestedGasPriceBumpRatio is the percentage by which to bump the suggested gas price to increase the chance of timely inclusion in blocks.",
                    "type": "integer"
                },
                "suggestedTokenPriceBumpRatio": {
                    "description": "SuggestedTokenPriceBumpRatio is the percentage by which to bump the suggested token price to increase the chance of timely inclusion in blocks when the price is volatile.",
                    "type": "integer"
                },
                "tokens": {
